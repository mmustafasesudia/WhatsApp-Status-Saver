...
public class WhatsAppVideosAdaptor extends RecyclerView.Adapter<WhatsAppVideosAdaptor.MyViewHolder> implements Subject {
    ...
    public WhatsAppVideosAdaptor(Context context, ArrayList<ModelStatus> arrayList) {
    ...
    @Override
    public WhatsAppVideosAdaptor.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_item_whatsapp_videos, parent, false);
