...
import com.mm.appstatus.Adaptor.WhatsAppPictureAdaptor;
 ...
 */
public class GBWhatsAppPicture extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_whats_app_status_pics, container, false);
        ...
        if (directory.exists()) {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected void onPostExecute(Void aVoid) {
                    ...
                    WhatsAppPictureAdaptor adapter = new WhatsAppPictureAdaptor(getActivity(), data);
            ...
            Snackbar.make(getActivity().findViewById(android.R.id.content), "GBWhatsApp Not Installed",
